...
- Optional USB firmware-link detection, device identity, descriptor diagnostics, readable/writable HID report-path summaries, and per-feature firmware-apply readiness for AirVision M1 hardware status
...
- Compact chat, notification summaries, voice controls, and captions.
- Per-mode M1 tuning profiles with labels, copy actions, JSON backup/import, brightness, distance, IPD, Eye Care, gestures, and hotkeys.
