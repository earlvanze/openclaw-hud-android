...
- Latest signed HUD AAB builds successfully from the current release commit:
  `build/release-bundles/openclaw-2026.7.17.14-hud-release.aab`
- Latest HUD AAB SHA-256:
  `0aa4600c904e9ca2690635ea724aadc62291f5ade1e86ff7d8deac3dd3179c29`
- Latest HUD bundle version: `2026.7.17.14 (2026071714)`.
...
- Live physical M1 capture on 2026-07-17 recorded three `KEY_PLAYPAUSE` tap
  ...
  v2026071712 adds a persisted Adaptive frame option that resolves the actual
  ...
  v2026071714 adds persisted 0.5-2.5-second mic double-tap timing presets and
  threads the selected timing through settings, profile backup, diagnostics,
  first-tap feedback, and Windows handoff exports.
  Unit, input-routing, Android lint, R8, release-signing, and Play-package
  checks pass. Exact v2026071714 device installation still requires a
...
- Browser staging verified the separate `ai.openclaw.app.hud` app, internal
  ...
  `2026071713` on 2026-07-17. The saved internal draft contains only
  `2026071713 (2026.7.17.13)`; version `2026071712` was removed after 1713 was
  attached, and the earlier versions remain absent. The saved release name is
  `OpenClaw HUD 2026.7.17.13 input feedback`; exact release notes persisted
  ...
  1713 remained the sole attached row, `Save as draft` was disabled, no error
  or dialog remained, and `Next` was not used. The default `en-US` listing was
  also replaced with the exact local title, short description, and 3,840-character
