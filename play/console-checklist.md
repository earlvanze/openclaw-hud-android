...
- Latest signed HUD AAB builds successfully from the current release commit:
  `build/release-bundles/openclaw-2026.8.12.0-r1-hud-release.aab`
- Latest HUD AAB SHA-256:
  `bfe72859c5fa29577f449d76c6f429a73d76c25ba7aca7174a3857f23280ffab`
- Latest HUD bundle version: `2026.8.12.0 (2026081200)`.
...
- Live physical M1 capture on 2026-07-17 recorded three `KEY_PLAYPAUSE` tap
  ...
  v2026071715 adds a session-only Input Monitor that traces forwarded and
  Presentation touch, recognized gestures, accessory keys, media callbacks,
  wheels, rotary input, and normalized axes with bounded sanitized history.
