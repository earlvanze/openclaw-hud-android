...
android {
    ...
    defaultConfig {
        ...
        minSdk = 31
        targetSdk = 36
        versionCode = 2026071714
        versionName = "2026.7.17.14"
        buildConfigField(
            "String",
    ...
    productFlavors {
        create("play") {
            ...
            buildConfigField("boolean", "OPENCLAW_DEFAULT_HUD", "false")
        }
        create("thirdParty") {
            dimension = "store"
        ...
        create("hud") {
            dimension = "store"
            applicationIdSuffix = ".hud"
            buildConfigField("boolean", "OPENCLAW_ENABLE_SMS", "false")
            buildConfigField("boolean", "OPENCLAW_ENABLE_CALL_LOG", "false")
            buildConfigField("boolean", "OPENCLAW_DEFAULT_HUD", "true")
        }
    }
