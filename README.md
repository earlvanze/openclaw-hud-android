...
overlay/dimming state, runtime-metadata freshness, all saved profile slots with
compact runtime summaries, Windows apply steps for View Mode, brightness, screen
distance, IPD, Splendid, Eye Care, Motion Sync, Light Load Mode, and 3D Mode,
Android HUD gesture/hotkey mappings, companion app startup/display/language,
