...
| Companion parity states | Implemented as a canonical app/export catalog that marks AirVision features as offline-reviewable, M1-optional, firmware-gated, or Windows-only. Diagnostics and Windows App Handoff both render from this catalog so Play review evidence, Android UI claims, and Windows handoff guidance stay aligned. |
