...
| Windows app profile handoff | Implemented as an exportable Markdown handoff containing the active profile, all saved profile values, ASUS Windows app apply steps for Cyber sessions, Android USB context, and privacy reminders that omit raw USB serial values. |
...
Mode, and Android USB context while omitting raw USB serial values, gateway
endpoints, auth tokens, and chat history.
