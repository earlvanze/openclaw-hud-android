...
const validReadme = [
  ...
  "Windows App Handoff exports ASUS Windows app apply steps, ASUS AirVision 1.0.7.1 build/settings-key evidence, VirtualSpaceDistance, SoftwareIPD, DisplaySplendidMode, DistanceHotkey, structured M1 hardware-key mapping, brightness/media key consumption state, Windows gesture catalog entries, structured support/legal/registration metadata, and privacy reminders while omitting raw USB serial values.",
